    ...
    <footer className="w-full bg-slate-900 px-4 py-14 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          <div>
            <h3 className="text-xl font-semibold text-white">Morning Briefing 🌅</h3>
            <p className="mt-3 text-sm text-slate-300">
              Your AI-powered morning briefing, delivered to Telegram every day.
            </p>
            <p className="mt-3 text-sm text-slate-400">Built with Gemini AI · Delivered via Telegram</p>
          </div>
          ...
          <div>
            ...
            <nav className="mt-4 space-y-2">
              ...
              <Link to="/pricing" className="block text-sm text-slate-400 transition hover:text-white">
                Pricing
              </Link>
              <Link to="/register" className="block text-sm text-slate-400 transition hover:text-white">
                Register
              </Link>
              <Link to="/login" className="block text-sm text-slate-400 transition hover:text-white">
                Login
              </Link>
            </nav>
          </div>
